...
/** GitHub mark — lucide dropped brand icons, so we ship our own. */
...
export function MarkdownIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="25 25 165 78" aria-hidden width="1em" height="1em" {...props}>
      <path
